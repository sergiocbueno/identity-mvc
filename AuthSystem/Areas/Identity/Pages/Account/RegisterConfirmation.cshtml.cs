...
internal sealed class RegisterConfirmationModel : RegisterConfirmationViewModel
{
    ...
    public override async Task<IActionResult> OnGetAsync(string email, string? returnUrl = null)
    {
		...
		//TODO: Review
        //DisplayConfirmAccountLink = _sender is DefaultMessageEmailSender<ApplicationUser> defaultMessageSender && defaultMessageSender.IsNoOp;
